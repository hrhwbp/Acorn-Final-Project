...
String w_no, w_mno, w_pname, w_image, w_addr, w_detail, w_like, w_lock, wg_detail, wg_no, wg_mno, w_price, g_num, m_name, m_email, wishcnt;
	...
	public String getW_lock() {
		return w_lock;
	}
	public void setW_lock(String w_lock) {
		this.w_lock = w_lock;
	}
